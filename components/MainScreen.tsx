...
const MainScreen = ({ navigation }) => {
  ...
  const openSpool = async () => {
    try {
      ...
      if (!ip || !serial || !code) {
        Alert.alert(
          'Printer settings are not configured. Please configure them in the settings menu.'
        );
        return;
      }
      ...
      MQTT.createClient({
        ...
        .then(function (client) {
          client.on('connect', function () {
            ...
            setMqttStatus('Data sent successfully');
            client.disconnect();
          });

          client.on('error', function (msg) {
            console.log('MQTT error', msg);
            setMqttStatus(`Error: ${msg}`);
          });
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.card} overScrollMode="always">
        ...
        <TouchableOpacity
            ...
            onPress={openSpool}
          >
            <Text style={styles.buttonText}>Open Spool</Text>
        </TouchableOpacity>
